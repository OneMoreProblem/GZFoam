...
%=================================================================
\documentclass[mathematics,article,submit,moreauthors,pdftex]{Definitions/mdpi} 
...
$^{2}$ \quad Institute for System Programming of the Russian Academy of Sciences, 109004, Moscow, Russia; Ryazanov Daniil ryazanov@ispras.ru (R.D.), Romanova Daria romanovadi@ispras.ru (Rom.D.)\\
...
The turbulence model  coefficients for slope flows were obtained with virtual sensors, and the calculated data were compared with the experimental ones. The calibration of turbulence model coefficients for calculating the free surface flows on test slopes using the multiphase model for interphase tracking has not been performed earlier. 
