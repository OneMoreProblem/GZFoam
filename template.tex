...
\newcommand{\orcidauthorF}{0000-0002-0722-6884} % Add \orcidF{} behind the author's name
\newcommand{\orcidauthorG}{0000-0002-0722-6884} % Add \orcidG{} behind the author's name

% Authors, for the paper (add full first names)
\Author{Konstantin Barkalov $^{1}$\orcidA{} and Ilya Lebedev $^{1}$\orcidB{} and Marina Usova$^{1}$\orcidC{} and Daria Romanova\orcidE{} and Sergei Strijak\orcidF{} and Daniil Ryazanov\orcidG{}}

% MDPI internal command: Authors, for metadata in PDF
\AuthorNames{Konstantin Barkalov and Ilya Lebedev and Marina Usova and Daria Romanova and Sergei Strijak and Daniil Ryazanov}

% MDPI internal command: Authors, for citation in the left column
\AuthorCitation{Barkalov, K.; Lebedev, I., Usova, M.; Romanova D.; Strijak S.; Ryazanov D.}
...
Методы, основанные на глубоком обучении (CNN), способны извлекать устойчивые пространственные и спектральные особенности \cite{Maggiori2017}. Комбинация спутникового изображения и топографических данных может быть использована для того чтобы обобщить высокоуровневые признаки на основе низкоуровневых признаков, чтобы лучше отличить склоновые потоки от других объектов \cite{Qin2021, Prakash2021}.
...
В работе проведен расчет двухфазного течения в лотке с использованием решателя interFoam, математической модели URANS и k-omega SST модели турбулентности. Выполнено сравнение результатов расчета профиля скорости с данными эксперимента НИИ Механики МГУ в различных сечения при изменении угла наклона лотка. Выполнен поиск оптимальных коэфициентов модели турбулентности путем минимизации целевая функция расхождения профиля скорости в лотке - RMSE.

MLPRegressor класс из Scikit-learn библиотеки был использован для построения  целевой функции аппроксимации. Выполнена оптимизация целевой функции с использованием критерия Липшица и ПО Globalizer Software, разработанного в ННГУ им. Лобачевского. При этом дополнительно была использована полносвязанная нейронная сеть с одним скрытым слоем для нахождения целевой функции в качестве выходного параметра.
