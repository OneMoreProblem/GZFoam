...
%В связи с выбором решателя менять скорость обучения (learning rate) и влиять на обновление весов не представляется возможным.
...
%дать краткое описание двух способов построения аппроксимации - SVR и NN, привести иллюстрации (можно - одномерные, можно - двумерные), сказать, что SVR нам тут не подходит, и мы будем использовать NN.
...
%нужен ли здесь пример работы алгоирмта на тестовой задаче?
