...
To obtain a system of linear algebraic equations, the PIMPLE algorithm is used, which is a combination of the PISO \cite{Holzmann2019, Yin2003} (Pressure Implicit with Splitting of Operator) \cite{Issa1986_2} and SIMPLE (Semi-Implicit Method for Pressure-Linked Equations) \cite{Issa1986_1} algorithms.
