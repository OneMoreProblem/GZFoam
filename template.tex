...
$^{2}$ \quad Institute For System Programming of Russian Academy of Science, 109004, Moscow, Russia; ryazanov@ispras.ru}
...
Изменению климата сопуствуют опасные природныя явления, которые в последнее время наблюдаются все чаще, что неизбежно влияет на жизнь человека и его повседневную деятельность. Изучение этих вопросов состоит в построении математических моделей, анализу геофизических данных, данных численных и натурных эксперементов. Современный тренд к активному использованию методов машинного обучения и искусственных нейронных сетей.
...
С помощью байесовского классификатора уже выполнялась калибровка коэффициентов в $\kappa-\epsilon$ модели турбулентности при изучении процесса распространения примесей в городской застройке \cite{Guillas2014}.
...
%TODO
%Здесь нужна фраза-связка о выборе оптимальных перемтров модели: есть сложная модель, надо выбрать оптимальные значения ее параметров. Например, вот такая:

% В модель склоновых потоков, как правило, входят несколько параметров, значения которых нельзя указать заранее, но можно выбрать, исходя из соответствия расчета по модели и имеющихся экспериментальных данных. Подобная задача является задачей глобальной оптимизации с целевой функцией вида черный ящик, т.к. конкретный вид целевой функции не известен, есть только алгоритм вычисления ее значений.
...
Минимальное значение для целевой функции получилось для случая угла лотка в 33 градусов. Один расчет целевой функции при заданных значениях параметров занимал в  среднем 15 минут с использованием 8 MPI-процессов на узле вычислительного кластера <<ЦКП Лобачевский>>.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\authorcontributions{``Conceptualization, Konstantin Barkalov. and Daniil Ryazanov; methodology, Romanova Daria and Konstantin Barkalov; software, Ilya Lebedev, Daniil Ryazanov, Marina Usova and  Romanova Daria; validation,  Romanova Daria and Ilya Lebedev; formal analysis, Sergei Strijhak, Marina Usova; investigation, Sergei Strijhak; resources, Ilya Lebedev; data curation, Romanova Daria and Marina Usova; writing---original draft preparation, Konstantin Barkalov, Sergei Strijhak and Romanova Daria; writing---review and editing, Ryazanov Daniil; visualization, Ilya Lebedev; supervision, Sergei Strijac; project administration, Konstantin Barkalov; funding acquisition, Konstantin Barkalov All authors have read and agreed to the published version of the manuscript.'', please turn to the  \href{http://img.mdpi.org/data/contributor-role-instruction.pdf}{CRediT taxonomy} for the term explanation. Authorship must be limited to those who have contributed substantially to the work~reported.}
