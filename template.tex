...
Подчеркнуть сложность оптимизационных задач с функциями вида ``черный ящик''
Использование аппроксимаций функций -- способ ускорения решения задачи с трудоемкими целевыми функциями
